...
// 직원 테이블
CREATE TABLE EMP (
    CMPNO       NUMBER(4) CONSTRAINT PK_EMP PRIMARY KEY,
    ENAME       VARCHAR2(10),
    JOB         VARCHAR2(9),
    MGR         NUMBER(4),
    HIREDATE    DATE,
...
INSERT INTO EMP VALUES (7654,'MARTIN','SALEMAN',7698,'81-09-28',1250,1400,30);
...
INSERT INTO EMP VALUES (7844,'TURNER','SAKESMAN',7698,'81-09-08',1500,0,30);
INSERT INTO EMP VALUES (7876,'ADAMS','CLERK',7788,'81-05-23',1100,NULL,20);
...
-- 3-2 실습. 숫자 함수
// SUM : 합계
SELECT SUM(SAL) AS 합계 FROM CMP;

// COUNT : 갯수
SELECT COUNT(*) AS 전체갯수 FROM EMP;
SELECT COUNT(COMM) AS COMM_갯수 FROM CMP;
...
INSERT INTO EMP
    VALUES (1001,'김유신','사원',7655,TO_CHAR(SYSDATE,'YYYY-MM-DD HH24:MI:SS'),3600,NULL,10);
